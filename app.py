...
with col1:
    ...
    <div style="background-color: #2e8b57; border-radius: 12px; padding: 1.5rem; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);">
        <h3 style="color: white !important; font-family: Poppins; text-align: center;">Vision</h3>
        <p style="color: white !important; font-size: 17px; line-height: 1.6; text-align: justify;">
...
with col2:
    st.markdown("""
    <div style="background-color: #2e8b57; border-radius: 12px; padding: 1.5rem; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);">
        <h3 style="color: white !important; font-family: Poppins; text-align: center;">Mission</h3>
        <p style="color: white !important; font-size: 17px; line-height: 1.6; text-align: justify;">
